...
class ProcessSquatsFrame:
    ...
    def process(self, frame: np.array, pose):
        ...
        if keypoints.pose_landmarks:
            ...
            landmarks_left = get_landmark_features(ps_lm.landmark, self.dict_features, 'left', frame_width,
                                                   frame_height)
            landmarks_right = get_landmark_features(ps_lm.landmark, self.dict_features, 'right', frame_width,
                                                    frame_height)

            left_shldr_coord = landmarks_left[0]
            left_hip_coord = landmarks_left[3]
            left_knee_coord = landmarks_left[4]
            left_ankle_coord = landmarks_left[5]
            left_foot_coord = landmarks_left[6]

            right_shldr_coord = landmarks_right[0]
            right_hip_coord = landmarks_right[3]
            right_knee_coord = landmarks_right[4]
            right_ankle_coord = landmarks_right[5]
            right_foot_coord = landmarks_right[6]
